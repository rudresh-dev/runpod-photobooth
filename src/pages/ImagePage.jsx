...
//             gender === 2 ? "bg-blue-500" : "bg-gray-500"
//           }`}
//           onClick={() => setGender(2)}
//         >
//           Male
...
//             gender === 1 ? "bg-pink-500" : "bg-gray-500"
//           }`}
//           onClick={() => setGender(1)}
//         >
//           Female
...
const ImagePage = () => {
  ...
  // Function to handle retake (reset the captured image)
  const handleRetake = () => {
    setIsCaptured(false);
        ...
        {!isCaptured ? (
          ...
          <div className="w-screen h-screen">
            ...
            <div className="absolute bottom-32 flex justify-center w-screen items-center z-0">
              <button className="bg-transparent text-white px-4 py-2 rounded-lg" onClick={handleRetake}>
               <FaRedo size={60} color="white"/>
              </button>
            </div>
          </div>
        )}
