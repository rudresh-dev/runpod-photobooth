...
const ImagePage = () => {
  ...
  // Retake image (clear captured state and reopen webcam)
  const handleRetake = () => {
      ...
      <div className="w-screen h-screen bg-blue-900">
        {!isCaptured ? (
          ...
          <div className="w-screen h-screen relative">
            ...
            <div className="absolute bottom-8 flex items-center justify-center w-screen">
            <button
              className="  text-black py-2 px-4 rounded-lg mr-40 mb-5"
              onClick={handleRetake}
            >
              <FaRedoAlt size={70} color="white"/>
            </button>
            </div>
